...
export default function SiteHeader () {
    ...
    const userDropDown = <nav className="flex items-stretch ml-auto mr-2">
        <div className="relative flex items-center group/dropdown">
            ...
            <div
                className="absolute top-full right-0 p-1 flex-col gap-1 bg-header-bg text-header-text hidden group-hover/dropdown:flex group-focus-within/dropdown:flex">
                {guestControls}
                {userControls}
            </div>
