@props(['job'])
<x-panel class="flex [&:nth-child(1n)>div:first-child]:bg-[#ffe1cb] [&:nth-child(2n)>div:first-child]:bg-[#d5f6ed] [&:nth-child(3n)>div:first-child]:bg-[#e2dbf9] [&:nth-child(4n)>div:first-child]:bg-[#e0f3ff] [&:nth-child(5n)>div:first-child]:bg-[#fbe2f3] [&:nth-child(6n)>div:first-child]:bg-[#eceff5]">
