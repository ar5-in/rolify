...
export default function JobListings({jobs, title, displayAs = 'grid', withSorting, count}) {
    ...
    return (
        <article>
            {titleComponent}
            <section className={displayAs === 'list' ? 'flex md:block space-x-5 md:space-x-0 md:space-y-5 overflow-x-auto md:overflow-x-visible' : 'grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'}>
